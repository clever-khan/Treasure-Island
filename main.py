...
print("""You are lost in a jungle in search for a treasure.
...
if direction == 'right':
    print("""This was a good choice. You have come to a river.
But you have to keep patience and wait for the boat to arrive.""")
    direction2 = input("Either 'wait' for the boat or 'swim' across the river: ").lower()
    if direction2 == 'wait':
        print("""Good One. Waiting is a good option. Success come to those
who are patient. Now the boat will soon arrive and you will succeed. """)
        direction3 = input(""" Now the boat landed you on dry earth and there are
three doors [ White | Black | Yellow ] in front of you choose 
a door and get your treasure: """).lower()
        if direction3 == 'white':
